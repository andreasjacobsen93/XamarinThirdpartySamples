...
namespace GoogleAdMobAds {
	...
	public unsafe partial class GADRequestError : NSError {
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("GADRequestError");
		...
		public GADRequestError (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
